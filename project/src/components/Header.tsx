        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            ...
            <nav className="hidden md:flex ml-10 space-x-4">
              <button onClick={onNewChat} className="px-3 py-2 rounded-md text-sm font-medium hover:bg-gray-800 hover:text-white transition-colors flex items-center gap-2">
                <BookOpen size={18} />
                New Chat
              </button>
            </nav>
